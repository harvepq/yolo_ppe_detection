...
if __name__ == "__main__":
  try:
    ...
    camera = 0
    detector = PPEMonitoring(camera, "models/trained/best.pt", [1, 3], imgsz=(1536, 864), conf=0.8, iou=0.7, verbose=False)
    detector()
  except:
    ...
    if detector.capture_loop_thread:
