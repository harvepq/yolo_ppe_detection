...
def extract_frames(video_path, frames_dir, overwrite=False, start=-1, end=-1, every=1):
    ...
    if every > 1800:  # this is faster for every > 25 frames and can fit in memory
...
if __name__ == '__main__':
    # test it
    video_to_frames(video_path='/home/harvey/Documents/yolo_ppe_detection/src/test.mp4', frames_dir='test_frames', overwrite=False, every=5)